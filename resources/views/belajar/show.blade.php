                ...
                <div class="col-xl-12 pt-1">
                    <div class="card custom-card profile-card">
                        <div class="profile-banner-img">
                            <img src="{{ asset($data_materi->banner) }}" class="card-img-top" alt="..." />
                        </div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body tab-content">
                                            <div class="tab-pane show active overflow-hidden p-0 border-0"
                                                id="product-details-pane" role="tabpanel" aria-labelledby="product-details"
                                                tabindex="0">
                                            ...
                                            <div class="tab-pane overflow-hidden p-0 border-0" id="key-features-tab-pane"
                                                role="tabpanel" aria-labelledby="key-features-tab" tabindex="1">
                                                <div class="border-block-end border-1">
                                                    <div id="pdfContainer"></div>
                                                    <!-- This will hold multiple canvases -->

                                                    <script>
                                                        var url = "{{ asset($data_materi->path) }}";
                                                        console.log(url);
